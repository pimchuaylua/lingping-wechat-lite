...
const TRANSLATIONS = {
    ...
    navAttending: { en: "Joining", zh: "参加中" },
    navHosting: { en: "My Ideas", zh: "我的点子" },
    ...
    pleaseNoteTitle: { en: "Please note", zh: "请注意" },
    costHeading: { en: "This event costs extra", zh: "此活动需额外付费" },
    costPillPayOnSpot: { en: "{amount} · Pay at venue", zh: "{amount} · 现场支付" },
    costPillPrepayRequired: { en: "Prepay {amount} to confirm", zh: "预付 {amount} 以确认" },
    costPillPrepayOptional: { en: "{amount} · Prepay optional", zh: "{amount} · 可选预付" },
    costSubtext: { en: "Not covered by your Lingping membership — paid directly to the venue.", zh: "会员资格不包含此费用 — 请直接支付给场地。" },
    costPerPerson: { en: "Cost per person", zh: "每人费用" },
    costPayOnSpotNote: { en: "Pay at the venue — bring cash or scan QR on the day.", zh: "现场支付 — 请当天携带现金或扫码支付。" },
    costPrepayRequiredLabel: { en: "Prepayment required to hold your spot", zh: "需预付款以保留名额" },
    costPayAmountNowBtn: { en: "Pay {amount} now", zh: "立即支付 {amount}" },
    costPrepayNowBtn: { en: "Prepay now", zh: "立即预付" },
    costPayAtVenueBtn: { en: "Pay at venue", zh: "现场支付" },
    costPrepayOptionalHelper: { en: "Prepaying is optional — you can also pay the host directly on the day.", zh: "预付为可选项 — 您也可以当天直接支付给主持人。" },
    ruleOnTime: { en: "Be polite and <strong>on time</strong>", zh: "请保持礼貌并<strong>准时</strong>" },
    ruleNoPlusOnes: { en: "Booked guests only — <strong>no plus-ones</strong>", zh: "仅限已预订者参加 — <strong>谢绝临时加入</strong>" },
    ruleCancelAhead: { en: "Cancel <strong>3+ hrs ahead</strong> if you can't make it", zh: "如无法参加，请<strong>提前3小时以上</strong>取消" },
    agreeReminders: { en: "I agree to the community guidelines & cancellation policy.", zh: "我同意社区准则和取消政策。" },
    agreeCheckboxError: { en: "Please check the box to continue", zh: "请勾选此项以继续" },
    ...
    eventsHosting: { en: "My Ideas", zh: "我的点子" },
    eventsAttending: { en: "Events I'm Joining", zh: "我参加的活动" },
